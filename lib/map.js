define(["map/clientlayer", "map/labelslayer",
  ...
  function (ClientLayer, LabelsLayer, d3, L, moment, LocationMarker, rbush) {
    ...
    var iconOnline  = { color: "#1566A9", fillColor: "#5DA439", radius: 6, fillOpacity: 0.9, opacity: 0.5, weight: 2, className: "stroke-first" }
	...
	// Note: The order in which nodes are added here also
	// controls the layering of the individual nodes
